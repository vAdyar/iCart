...
import com.application.cart.PaymentApp;
import com.application.cart.config.TestSecurityConfiguration;
import com.application.cart.domain.Shipment;
import com.application.cart.domain.Invoice;
import com.application.cart.repository.ShipmentRepository;
import com.application.cart.service.ShipmentService;
 ...
 */
@SpringBootTest(classes = { PaymentApp.class, TestSecurityConfiguration.class })
...
public class ShipmentResourceIT {
    ...
    public void createShipment() throws Exception {
        ...
        // Create the Shipment
        restShipmentMockMvc.perform(post("/api/shipments").with(csrf())
    ...
    public void updateShipment() throws Exception {
        ...
        restShipmentMockMvc.perform(put("/api/shipments").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteShipment() throws Exception {
        ...
        // Delete the shipment
        restShipmentMockMvc.perform(delete("/api/shipments/{id}", shipment.getId()).with(csrf())
