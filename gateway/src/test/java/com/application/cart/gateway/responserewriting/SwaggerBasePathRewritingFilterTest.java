package com.application.cart.gateway.responserewriting;
...
import static com.application.cart.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
