...
export const ProductDetail = (props: IProductDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="gatewayApp.product.detail.title">Product</Translate> [<b>{productEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="size">
              <Translate contentKey="gatewayApp.product.size">Size</Translate>
            </span>
          </dt>
          <dd>{productEntity.size}</dd>
          <dt>
            <span id="image">
              <Translate contentKey="gatewayApp.product.image">Image</Translate>
            </span>
          </dt>
          <dd>
            {productEntity.image ? (
          ...
          <dt>
            <Translate contentKey="gatewayApp.product.productCategory">Product Category</Translate>
          </dt>
