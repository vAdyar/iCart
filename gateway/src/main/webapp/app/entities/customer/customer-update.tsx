  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.customer.home.createOrEditLabel">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : customerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="MALE">{translate('gatewayApp.Gender.MALE')}</option>
                  <option value="FEMALE">{translate('gatewayApp.Gender.FEMALE')}</option>
                  <option value="OTHER">{translate('gatewayApp.Gender.OTHER')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
