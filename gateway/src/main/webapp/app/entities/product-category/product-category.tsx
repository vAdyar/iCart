  ...
  return (
    <div>
      <h2 id="product-category-heading">
        <Translate contentKey="gatewayApp.productCategory.home.title">Product Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gatewayApp.productCategory.home.createLabel">Create new Product Category</Translate>
        </Link>
      </h2>
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="gatewayApp.productCategory.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="gatewayApp.productCategory.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.productCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )
        )}
      </div>
