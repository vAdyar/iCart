...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.productCategory.delete.question">
        <Translate contentKey="gatewayApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
